...
function gen_payments_table(datajson, table){
  ...
  vartable.fnAddData([
    ...
    status.elaboro,
    '<a href="javascript:void(0);" onclick="enviar(this)" value="'+status.id_payment+'" class="btn btn-default btn-xs" role="button" data-target="#modal-concept"><span class="fa fa-eye"></span></a><a href="javascript:void(0);" onclick="enviartwo(this)" value="'+status.id_payment+'" class="btn btn-danger btn-xs" role="button" data-target="#modal-deny" title="Denegar pago"><span class="fa fa-ban"></span></a>',
    ]);
  });
}
