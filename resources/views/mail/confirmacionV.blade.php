...
<title>Confirmación de solicitud de viatico.</title>
<style type="text/css">
img {
max-width: 20%;
}
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                    <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;">Confirmación de solicitud de viático.</h1>
                    <h2 style="margin-top: 5; color: #2F3133;  font-size: 14px;  font-weight: bold;  text-align: left;">Servicio: <strong>{{$param['servicio']}}</strong></h2>
                    ...
                    <p style="margin-top: 20;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Estimado <strong>{{Auth::user()->name}}</strong> tu solicitud de viaticos fue aprobada.</p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Gerente que aprobó: <strong>{{$param['gerente']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Beneficiario: <strong>{{$param['nombre_b']}}</strong></p>
                    ...
                    <p style="margin-top: 0;
                              ...
                              text-align: left;
                              font-size: 14px;
                              text-align: left;">Fecha Inicio: <strong>{{$param['fecha_inicio']}}</strong>, Fecha Fin: <strong>{{$param['fecha_fin']}}</strong></p>
                    ...
                    <p style="margin-top: 0;
                        ...
                        <table class="greyGridTable">
                          <caption><small>Solicitud.</small></caption>
                          <thead>
                          <tr>
                          ...
                          <th> <small>Subototal.</small> </th>
                          </tr>
                          </thead>
                          @for ($i = 0; $i < count($param1); $i++)
                          <tr>
                            <td>{{$param1[$i]['venue']}}</td>
                            <td>{{$param1[$i]['hotel']}}</td>
                            <td>{{$param1[$i]['concept']}}</td>
                            <td>{{$param1[$i]['cantidad']}}</td>
                            <td>{{$param1[$i]['costo']}}</td>
                            <td>{{$param1[$i]['total']}}</td>
                          </tr>
                          @endfor
                          </tbody>
                          @php
